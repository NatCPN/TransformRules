	...
	public static void main(String[] args) {
		...
		try {		
			...
			for(int i=1; i<=numMutants; i++) {				
				...
				pb.directory(new File("C:\\Users\\Samanta\\workspace\\NAT2TEST_Phases1_2_3_4\\PC\\bin"));
		        Process pr = pb.start();
...
//				String snextline = s.nextLine();
//				result = Boolean.parseBoolean(snextline);
//				System.out.println(snextline);
//				buffer.append("Result: " + result + " - Killed: " + killed.size() + " - Alive: " + alive.size() + "\n");				
