...
//			for (int i=0; i<=numMutants; i++) {
				...
				if ( i == 0 ) {
					Driver.SUTClass = Class.forName("TIS");
				} else {
					Driver.SUTClass = Class.forName("TIS" + i);
				}
...
//						String filename = "D:/Bruno/Mestrado/SCP2016/Revisao_Artigo_SCP/TIS/output/reps_9/sim_";
						String filename = "D:/Bruno/Mestrado/SCP2016/Revisao_Artigo_SCP/TIS/output/reps_42/sim_";
						filename += j + "/TC.csv";
...
//										Driver.SUTClass.getField("ifN").getInt(Driver.SUT);
								...
								int the_indication_lights =
										Driver.SUTClass.getField("the_indication_lights").getInt(Driver.SUT);
								the_flashing_mode =
										Driver.SUTClass.getField("the_flashing_mode").getInt(Driver.SUT);
								int the_flashing_timer =
										Driver.SUTClass.getField("the_flashing_timer").getInt(Driver.SUT);

								int primed_the_indication_lights =
										Driver.SUTClass.getField("primed_the_indication_lights").getInt(Driver.SUT);
								int primed_the_flashing_mode =
										Driver.SUTClass.getField("primed_the_flashing_mode").getInt(Driver.SUT);
								int primed_the_flashing_timer =
										Driver.SUTClass.getField("primed_the_flashing_timer").getInt(Driver.SUT);
...
//											+" && "+ the_flashing_timer +"=="+ primed_the_flashing_timer +  " - TIME:" + TIME + " - ifN= " + retIFn);
									...
									if (the_flashing_mode != primed_the_flashing_mode) {
										Driver.SUTClass.getField("old_the_flashing_mode").setInt(Driver.SUT, the_flashing_mode);
									}
									
									Driver.SUTClass.getField("the_indication_lights").setInt(Driver.SUT, primed_the_indication_lights);
									Driver.SUTClass.getField("the_flashing_mode").setInt(Driver.SUT, primed_the_flashing_mode);
									Driver.SUTClass.getField("the_flashing_timer").setInt(Driver.SUT, primed_the_flashing_timer);									
								}								
...
//							Driver.SUTClass.getField("old_the_flashing_mode").setInt(Driver.SUT, the_flashing_mode);
							...
							Driver.SUTClass.getField("old_the_voltage").setInt(Driver.SUT, the_voltage);
							Driver.SUTClass.getField("old_the_turn_indicator_lever").setInt(Driver.SUT, the_turn_indicator_lever);
							Driver.SUTClass.getField("old_the_emergency_flashing").setInt(Driver.SUT, the_emergency_flashing);
							
							int temp1 = Driver.SUTClass.getField("the_indication_lights").getInt(Driver.SUT);
...
//						}
							...
							int temp2 = Driver.SUTClass.getField("the_flashing_mode").getInt(Driver.SUT);
