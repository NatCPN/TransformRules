...
//				pb.directory(new File("C:\\Users\\Samanta\\workspace\\NAT2TEST_Phases1_2_3_4\\VM\\bin"));
				pb.directory(new File("C:/Users/Samanta/workspace/NAT2TEST_Phases1_2_3_4/VM/bin/"));
//				System.out.println("pb "+pb.directory());
		        Process pr = pb.start();
...
//				s = new Scanner(new File("C:\\Users\\Samanta\\workspace\\NAT2TEST_Phases1_2_3_4\\VM\\bin\\Statistics" + i + ".txt"));
